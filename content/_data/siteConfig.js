...
module.exports = {
  ...
  site: {
    ...
    description: "One man's thoughts for almost 20 years...",
    ...
    url: process.env.URL || 'https://beta.chrishubbs.com/',
    ...
    fediverse: [
      {
        ...
        url: 'https://mastodon.online/@cjhubbs',
      },
    ],
  },
  // ---------------------------------------------------------------------------
